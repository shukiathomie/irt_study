...
from opt.em_clustered_dmm_algo import EM_DMM_Algo
...
def main(T):
    ...
    T = T
    # パスの指定
    indpath = "/Users/shukitakeuchi/Library/Mobile Documents/com~apple~CloudDocs/研究/項目反応理論/data2/30*100"
    ...
    em_dmm_algo = EM_DMM_Algo(U, Y, T, target_df, n_clusters)
    W_est, Y_est, Z_est = em_dmm_algo.process()
